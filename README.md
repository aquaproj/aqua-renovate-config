...
* :thumbsup: `"github>aquaproj/aqua-renovate-config#1.2.1"`
...
{
  "extends": [
    "github>aquaproj/aqua-renovate-config#1.2.1"
  ]
}
```
...
{
  "extends": [
    "github>aquaproj/aqua-renovate-config:file#1.2.1(aqua/.*\\.ya?ml)"
  ]
}
```
...
{
  "extends": [
    "github>aquaproj/aqua-renovate-config:installer-script#1.2.1(scripts/.*\\.sh)"
  ]
}
```
