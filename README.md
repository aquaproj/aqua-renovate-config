...
* :thumbsup: `"github>aquaproj/aqua-renovate-config#1.2.2"`
...
registries:
- type: standard
  ref: v3.23.0 # renovate: depName=aquaproj/aqua-registry
...
{
  "extends": [
    "github>aquaproj/aqua-renovate-config:installer-script#1.2.2(scripts/.*\\.sh)"
  ]
}
```
