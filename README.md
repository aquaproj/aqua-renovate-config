...
* :thumbsup: `"github>aquaproj/aqua-renovate-config#1.3.0"`
...
{
  "extends": [
    "github>aquaproj/aqua-renovate-config:file#1.3.0(aqua/.*\\.ya?ml)"
  ]
}
```
...
{
  "extends": [
    "github>aquaproj/aqua-renovate-config:installer-script#1.3.0(scripts/.*\\.sh)"
  ]
}
```
