...
registries:
- type: standard
  ref: v3.109.0 # renovate: depName=aquaproj/aqua-registry
...
```sh
curl -sSfL https://raw.githubusercontent.com/aquaproj/aqua-installer/v2.0.1/aqua-installer | bash -s -- -v v1.25.0
```
...
```sh
curl -sSfL https://raw.githubusercontent.com/aquaproj/aqua-installer/v2.0.1/aqua-installer |
